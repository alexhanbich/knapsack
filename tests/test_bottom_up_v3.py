...
class KnapsackBottomUpV3Test(unittest.TestCase):
    def setUp(self):
    ...
    def test1(self):
        ...
        actual = knapsack_solver.knapsack_bottom_up_v3()
    ...
    def test9(self):
        dp = [[0 for rc in range(6404180)] for i in range(24)]
        self.assertIsNotNone(dp)

if __name__ == '__main__':
    suite = unittest.TestLoader().loadTestsFromTestCase(KnapsackBottomUpV3Test)
