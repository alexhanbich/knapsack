...
class KnapsackTopDownTest(unittest.TestCase):
    def setUp(self):
    ...
    def test1(self):
        ...
        actual = knapsack_solver.knapsack_top_down()
...
if __name__ == '__main__':
    suite = unittest.TestLoader().loadTestsFromTestCase(KnapsackTopDownTest)
