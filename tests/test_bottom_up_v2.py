...
class KnapsackBottomUpV2Test(unittest.TestCase):
    def setUp(self):
    ...
    def test1(self):
        ...
        actual = knapsack_solver.knapsack_bottom_up_v2()
...
if __name__ == '__main__':
    suite = unittest.TestLoader().loadTestsFromTestCase(KnapsackBottomUpV2Test)
